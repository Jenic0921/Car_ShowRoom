...
<%@ page import = "dao.BookRepository2" %>
    ...
    <header class="header" style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <div class="nevigation">
            ...
            <p> <a href= "member/loginMember.jsp" style="background-color: #fff; color: #000; padding: 10px 20px; text-decoration: none; font-size: 18px; font-weight: bold;">로그인</a>
            	...
            	<a href= "addBook2.jsp" style="background-color: #fff; color: #000; padding: 10px 20px; text-decoration: none; font-size: 18px; font-weight: bold;">신규 차량 등록하기</a>
...
<div class="row">
    ...
    int count = 0;
    try {
        BookRepository2 dao = BookRepository2.getInstance();
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="h-100 p-2">
            ...
            <p> <a href="./book2.jsp?id=<%=rs.getString("id") %>" class="btn btn-secondary" role="button"> 상세 정보 &raquo;></a>
        </div>
    </div>
    <%
        count++;
